...
import { ScreenLayout, Header, Text, useTheme } from '@ongo/ui';
    ...
    return (
        <ScreenLayout>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
                ...
                <View
                    style={[styles.termsContainer, { borderColor: colors.border, backgroundColor: colors.background }]}
                >
                    {/* 1. 용어의 정의 */}
